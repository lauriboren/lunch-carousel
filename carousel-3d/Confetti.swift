...
//func createConfettiCells2() -> [CAEmitterCell] {
...
//        cell.beginTime = 0.1
//        cell.birthRate = 100
//        cell.contents = ["🦞", "🍔"].randomElement()!.image().cgImage //confettiType.image.cgImage
//        cell.emissionRange = CGFloat(Double.pi)
//        cell.lifetime = 10
//        cell.spin = 2
//        cell.spinRange = 2
...
//func createConfettiLayer(inView view: UIView) -> CAEmitterLayer {
